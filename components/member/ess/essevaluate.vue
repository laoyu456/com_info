<template>
	<view class="warp">
		<view class="group">
			<view class="evbox flex-row bd">
				<view class="flex-1">
					<view>综合评分</view>
					<view class="fb">4.2</view>
				</view>
				<view class="flex-1">
					<view>态度</view>
					<view class="fb">4.2</view>
				...
				<view class="u-body-item flex-row bd">
					...
					<view class="flex-col textbox">
						<view class="flex-1 fw">
							服务标题服务标题服务标题服务标题服务标题服务标题服务标题服务标题服务标题
						</view>
...
<style>
	page{height: 100%;}
	.title{padding:20rpx ; font-size: 30rpx; font-weight: bold;}
	.evbox{padding: 20rpx; text-align: center; line-height: 50rpx;}
	.evbox view{font-size: 26rpx; color: #999999;}
	.evbox view.fb{font-size: 28rpx; color: #333333; font-weight: bold;}
...
.set:hover .group17{display: block;}
.group17:before{
	content: '';
	width: 0;
	height: 0;
...
.label1 {
  ...
  margin: 4rpx 0 0 2rpx;
	...
	.u-body-item .textbox{height: 100rpx;flex-flow: column; flex-direction: column; padding-left: 30rpx; font-size: 14rpx;}
</style>
